...
def findPositionsInBoard(board_predictions):
    ...
    for h in range(board_predictions.shape[1] - 2):
        ...
        for w in range(board_predictions.shape[0] - 2):
            ...
            current_sum = (
                board_predictions[h + 0][w + 0][3] +
                board_predictions[h + 0][w + 1][3] +
                board_predictions[h + 0][w + 2][3] +
                board_predictions[h + 1][w + 0][3] +
                board_predictions[h + 1][w + 1][3] +
                board_predictions[h + 1][w + 2][3] +
                board_predictions[h + 2][w + 0][3] +
                board_predictions[h + 2][w + 1][3] +
                board_predictions[h + 2][w + 2][3]
            )

            if current_sum > best_sum:
                best_sum = current_sum
                current_board = np.zeros((3, 3), dtype=int)
                current_board[0][0] = board_predictions[h + 0][w + 0][2]
                current_board[0][1] = board_predictions[h + 0][w + 1][2]
                current_board[0][2] = board_predictions[h + 0][w + 2][2]
                current_board[1][0] = board_predictions[h + 1][w + 0][2]
                current_board[1][1] = board_predictions[h + 1][w + 1][2]
                current_board[1][2] = board_predictions[h + 1][w + 2][2]
                current_board[2][0] = board_predictions[h + 2][w + 0][2]
