...
from src.domain.data_classes.RobotGripper import RobotGripperControl, RobotGripperInfo
...
from src.domain.data_classes.RobotPuckTransporter import RobotPuckTransporterControl, RobotPuckTransporterInfo


class RobotInfos:
    def __init__(self):
        self.__position = Point2D(0, 0)  # todo change 0,0
